...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-emerald-100 flex font-['Fira_Code',_monospace] antialiased relative crt overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className="w-[250px] border-r border-emerald-600/40 bg-[#0a120a]/80 backdrop-blur-sm flex flex-col fixed inset-y-0 left-0 z-10 shadow-[0_0_24px_rgba(16,255,128,0.15)]">
      ...
      {/* Main Content */}
      <main className="flex-1 ml-[250px] flex flex-col min-h-screen bg-transparent">
        <header className="h-14 border-b border-emerald-700/50 bg-[#060c08]/80 backdrop-blur supports-[backdrop-filter]:bg-[#060c08]/80 px-6 flex items-center sticky top-0 z-10 shadow-[0_0_16px_rgba(16,255,128,0.08)]">
